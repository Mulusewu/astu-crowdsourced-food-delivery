...
export default function ActiveDeliveryPage() {
  ...
  const handleDeliveryAction = (deliveryId: string, action: string) => {
    // Handle delivery actions (pickup, start, complete, etc.)
                ...
                <CardContent className="p-0">
                  ...
                  <div className="flex items-center justify-between p-4 bg-white">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        handleDeliveryAction(delivery.id, "details")
                      }
                  ...
                  <div className="p-4 pt-0 flex gap-2">
                    {delivery.status === "assigned" && (
                      <Button
                        onClick={() =>
                          handleDeliveryAction(delivery.id, "pickup")
                        }
                    ...
                    {delivery.status === "picked_up" && (
                      <Button
                        onClick={() =>
                          handleDeliveryAction(delivery.id, "start")
                        }
                        className="flex-1 bg-primary hover:bg-primary/90"
                      >
                        Start Delivery
                    ...
                    {delivery.status === "in_transit" && (
                      <Button
                        onClick={() =>
                          handleDeliveryAction(delivery.id, "complete")
                        }
                  ...
                  {(delivery.status === "assigned" ||
                    ...
                    <div className="px-4 pb-4">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          handleDeliveryAction(delivery.id, "report")
                        }
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-semibold text-gray-900">
                    {Math.round(
                      (stats.completedToday /
                        (stats.activeDeliveries + stats.completedToday)) *
                        100,
                    )}
                    %
                  </p>
