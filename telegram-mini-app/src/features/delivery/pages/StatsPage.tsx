...
export default function StatsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] px-5 pt-6 pb-28">
      <div className="relative flex items-center justify-center">
        ...
        <h1 className="text-xl font-black text-gray-900">Delivery Statistics</h1>
      </div>
      ...
      <div className="mt-8 space-y-4">
        <div className="rounded-[28px] bg-white p-5 shadow-[0_6px_24px_rgba(0,0,0,0.05)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-500">Deliveries Today</p>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-[28px] bg-white p-5 shadow-[0_6px_24px_rgba(0,0,0,0.05)]">
            ...
            <p className="mt-3 text-sm font-semibold text-gray-500">Rating</p>
            <p className="text-xl font-black text-gray-900">{delivererProfile?.rating ?? 0}</p>
          </div>
          <div className="rounded-[28px] bg-white p-5 shadow-[0_6px_24px_rgba(0,0,0,0.05)]">
            <Truck className="text-[#F26A1C]" />
            <p className="mt-3 text-sm font-semibold text-gray-500">Shift Status</p>
