...
import { Home, LayoutList, ClipboardList, User, Bell } from "lucide-react";
...
export default function VendorBottomNav() {
  ...
  const isHomeActive = path === "/vendor/dashboard" || path === "/vendor";
    ...
    <nav className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-md">
      <div className="relative w-full h-[65px]">
        ...
        <div className="absolute inset-0 flex justify-between items-center px-6">
          ...
          <NavIconButton
            icon={LayoutList} // Menu/Food Items management
            isActive={isActive("menu") || isActive("items")}
          ...
          <NavIconButton
            icon={ClipboardList} // Order history/reports
            isActive={isActive("history") || isActive("reports")}
        ...
        {/* Floating Center Action Button (Active Incoming Orders) */}
        <div className="absolute top-[-24px] left-1/2 -translate-x-1/2 z-20">
          <button
            onClick={() => navigate("/vendor/orders/active")}
